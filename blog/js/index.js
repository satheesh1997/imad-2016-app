...
function loadtrends(){
    ...
    request.onreadystatechange = function () {
      	...
      	if (request.status === 200) {
        	...
        	t1.innerHTML=`<div class="loader4"></div><p class="lead text-center text-danger">ERROR</p>`;
					t2.innerHTML=`<div class="loader4"></div><p class="lead text-center text-danger">ERROR</p>`;
					t3.innerHTML=`<div class="loader4"></div><p class="lead text-center text-danger">ERROR</p>`;
					t4.innerHTML=`<div class="loader4"></div><p class="lead text-center text-danger">ERROR</p>`;
					t5.innerHTML=`<div class="loader4"></div><p class="lead text-center text-danger">ERROR</p>`;
        }
    }
	};
